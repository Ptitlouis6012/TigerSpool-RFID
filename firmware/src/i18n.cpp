...
/* S_AP_JOIN         */ {{ "Scan with your phone", "Scannez avec votre téléphone", "Mit dem Handy scannen", "Escanea con el movil", "Inquadra col telefono", "Zeskanuj telefonem", "Escaneie com o celular", "Digitalize com o telemovel", "用手机扫码" }},
...
/* S_SCAN_TO_LINK   */ {{ "Or go to tigersystem.io/pair", "Ou allez sur tigersystem.io/pair", "Oder tigersystem.io/pair offnen", "O ve a tigersystem.io/pair", "O vai su tigersystem.io/pair", "Lub wejdz na tigersystem.io/pair", "Ou acesse tigersystem.io/pair", "Ou va a tigersystem.io/pair", "或访问 tigersystem.io/pair" }},
